...
```text
cv/
  19_04Timmy Huang Full Stack Developer.txt
  cv_template.md
jobs/
...
Read `cv/19_04Timmy Huang Full Stack Developer.txt` and `jobs/SoftwareQA_RosterLab.md`,
...
读取 `cv/19_04Timmy Huang Full Stack Developer.txt` 和 `jobs/SoftwareQA_RosterLab.md`，
...
CV file: `cv/19_04Timmy Huang Full Stack Developer.txt`
...
```text
请帮我根据这个岗位定制简历。
CV 文件：`cv/19_04Timmy Huang Full Stack Developer.txt`
...
```text
cv/Timmy_Huang_[CompanyName_JobTitle]v[N].md
```
...
```text
Use `tailor-resume`.
CV: `cv/19_04Timmy Huang Full Stack Developer.txt`
